---
path: '/web-integration/sitemap/examples/ecommerce'
title: 'Example Ecommerce Sitemap'
        ...
        pageTypes: [
            {
                name: "product_detail",
                isMatch: () => {
                    return Evergage.DisplayUtils.pageElementLoaded("div.page[data-action='Product-Show']", "html").then(() => true);
                },
                catalog: {
                    Product: {
                        _id: () => {
            ...
            },
            {
                ...
                isMatch: () => {
                    return Evergage.DisplayUtils.pageElementLoaded(".page[data-action='Search-Show']", "html").then((ele) => {
                        return Evergage.DisplayUtils.pageElementLoaded(".breadcrumb").then(() => true);
                    });
                },
                catalog: {
                    Category: {
            ...
            },
            {
                ...
                isMatch: () => {
                    return Evergage.DisplayUtils.pageElementLoaded(".page[data-action='Search-Show']", "html").then((ele) => {
                        return Evergage.DisplayUtils.pageElementLoaded("h2.header").then(() => true);
                    });
                }
            },
            {
